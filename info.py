...
# Bot information
API_ID = environ.get('API_ID', '9063763')
if len(API_ID) == 0:
    logging.error('API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '781c84efb2c1a593f0dca3cd27758b46')
if len(API_HASH) == 0:
    logging.error('API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6611560877:AAELoBhwmNjymDtlK4d2zEGcpt066ZLkpUU')
if len(BOT_TOKEN) == 0:
